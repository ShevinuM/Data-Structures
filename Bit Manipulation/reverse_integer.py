...
class Solution:
    # This was my initial solution to this problem but I realized this approach was too slow because of O(n) time complexity
...
class Test:
    print()
    print("Test for my second approach")
